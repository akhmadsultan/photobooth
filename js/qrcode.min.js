/* QRCode.js v1.0.0 (Davidshimjs / standard clean implementation) */
var QRCode;
(function () {
  function QRCode(el, opt) {
    ...
    this._el = el;
    this._oQRCode = null;
    this._htOption.correctLevel = this._htOption.correctLevel || QRErrorCorrectLevel.H;
  ...
  QRCode.prototype.makeCode = function (sText) {
    ...
    this._oQRCode.make();
    this._el.innerHTML = "";
    this._oDrawing = new QRCodeDrawing(this._el, this._htOption);
  ...
  function QRCodeDrawing(el, htOption) {
    this._el = el;
  ...
  QRCode.prototype._getTypeNumber = function (sText, nCorrectLevel) {
    ...
    for (var i = 0, len = QRCodeLimitLength.length; i < len; i++) {
      ...
      if (length <= nLimit) return i + 1;
    }
    return nType;
  };

  function _getUTF8Length(sText) {
    var replaceText = sText.replace(/[\u0080-\u07ff]/g, '00');
    replaceText = replaceText.replace(/[\u0800-\uffff]/g, '000');
  ...
  function QRPolynomial(num, errorLength) {
    if (num.length == undefined) throw new Error(num.length + "/" + errorLength);
    var offset = 0;
    while (offset < num.length && num[offset] == 0) offset++;
    this.num = new Array(num.length - offset + errorLength);
  ...
  RSBlock.getRSBlocks = function (typeNumber, errorCorrectLevel) {
    var rsBlock = RSBlock.getBsSpec(typeNumber, errorCorrectLevel);
  ...
  RSBlock.getBsSpec = function (typeNumber, errorCorrectLevel) {
  ...
  var QRUtil = {
    ...
    getLengthInBits: function (mode, type) {
      if (1 <= type && type < 10) {
        switch (mode) { case 4: return 8; }
      } else if (type < 27) {
        switch (mode) { case 4: return 16; }
      }
      return 16;
    },
