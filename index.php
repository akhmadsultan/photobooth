...
<link rel="stylesheet" href="css/v2.css?v=sponge6">
...
<!-- Google Drive QR Code Modal -->
<div id="qrModal" class="qr-modal-overlay" style="display:none;">
  <div class="qr-modal-content">
    <div class="qr-modal-header">
      <span class="qr-modal-title">Sesi Foto Tersimpan! 🐠</span>
      <button class="qr-modal-close-btn" id="btnCloseQrModal">&times;</button>
    </div>
    <div class="qr-modal-body">
      <p class="qr-modal-text">Pindai QR Code di bawah untuk mengunduh hasil foto (strip, boomerang, & frame) langsung dari Google Drive:</p>
      
      <div class="qr-code-wrapper">
        <img id="qrCodeImg" class="qr-code-img" src="" alt="Google Drive QR Code">
        <div class="qr-demo-badge" id="qrDemoBadge" style="display:none;">DEMO / UNCONFIGURED</div>
      </div>
      
      <div class="qr-links">
        <a id="qrDirectLink" class="qr-direct-link" href="#" target="_blank">Buka Link Google Drive secara langsung</a>
      </div>
    </div>
    <div class="qr-modal-footer">
      <button class="qr-btn qr-btn-primary g-click" id="btnQrNewSession">Mulai Sesi Baru 📸</button>
      <button class="qr-btn qr-btn-secondary g-click" id="btnQrClose">Tutup</button>
    </div>
  </div>
</div>
...
<script src="js/v2-webrtc.js?v=3"></script>
<script src="js/v2-gesture.js?v=5"></script>
<script src="js/v2-filters.js?v=3"></script>
<script src="js/v2-strip.js?v=3"></script>
<script src="js/v2-gif.js?v=3"></script>
<script src="js/v2-api.js?v=3"></script>
<script src="js/v2-stickers.js?v=3"></script>
<script src="js/v2-app.js?v=3"></script>
